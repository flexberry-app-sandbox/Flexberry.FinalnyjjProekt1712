...
moduleForModel('i-i-s-finalnyjj-proekt1712-должности', 'Unit | Serializer | i-i-s-finalnyjj-proekt1712-должности', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-finalnyjj-proekt1712-должности',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
