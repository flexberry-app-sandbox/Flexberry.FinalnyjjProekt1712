...
namespace IIS.Finalnyjj_proekt1712
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Finalnyjj_proekt1712.Должности fДолжности;
        
        private IIS.Finalnyjj_proekt1712.Отделы fОтделы;
        ...
        /// КодСот.
        /// </summary>
        // *** Start programmer edit section *** (Сотрудники.КодСот CustomAttributes)

        // *** End programmer edit section *** (Сотрудники.КодСот CustomAttributes)
        [NotNull()]
        public virtual int КодСот
        {
            get
            {
                // *** Start programmer edit section *** (Сотрудники.КодСот Get start)

                // *** End programmer edit section *** (Сотрудники.КодСот Get start)
                int result = this.fКодСот;
                // *** Start programmer edit section *** (Сотрудники.КодСот Get end)

                // *** End programmer edit section *** (Сотрудники.КодСот Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Сотрудники.КодСот Set start)

                // *** End programmer edit section *** (Сотрудники.КодСот Set start)
                this.fКодСот = value;
                // *** Start programmer edit section *** (Сотрудники.КодСот Set end)

                // *** End programmer edit section *** (Сотрудники.КодСот Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Finalnyjj_proekt1712.Должности Должности
        {
            get
            {
                ...
                IIS.Finalnyjj_proekt1712.Должности result = this.fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Отделы"})]
        [NotNull()]
        public virtual IIS.Finalnyjj_proekt1712.Отделы Отделы
        {
            get
            {
                ...
                IIS.Finalnyjj_proekt1712.Отделы result = this.fОтделы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Finalnyjj_proekt1712.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Finalnyjj_proekt1712.Сотрудники));
                }
            }
        }
    }
